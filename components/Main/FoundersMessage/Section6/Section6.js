...
export default function Section6() {
  const data = [
    {
      ...
      title: "Vipin Sharma",
      sub_title:
        "Founder, Chief <span style='color:red';>Execution</span> Officer",
      linked_href:
    ...
    {
      id: 7,
      image: "/assets/images/about/kk.png",
      title: "Krishna Kumar",
      sub_title: "Chief Technology Officer",
      linked_href: "https://www.linkedin.com/in/mvpstrategist/",
    },
    {
      id: 3,
    ...
    // },
    {
      ...
      linked_href:
        "https://www.linkedin.com/in/azra-akhoon-6134801a7?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  const renderContactInfo = (email, phone, linked_href) => (
    <div className={style["team-social-media"]}>
      <ul>
        {linked_href && (
          <li>
            <a href={linked_href} target="_blank" rel="noreferrer">
              <FaLinkedin />
            </a>
          </li>
        )}
            ...
            <div className="row justify-content-center py-5">
              {mentors.map((item) => (
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30" key={item.id}>
                  <div
                    className={
                      style["team-inner"] + " " + style["team-inner-about-page"]
                    }
                  >
                    <Image
                      width={384}
          ...
          <div className="row justify-content-center">
            {teamMembers.length > 0 ? (
              teamMembers.map((item) => (
                <div className="col-xl-3 col-lg-3 col-md-6 mb-30" key={item.id}>
                  <div
                    className={
                      style["team-inner"] + " " + style["team-inner-about-page"]
                    }
